...
void ShowTexture(float NumberOfSprite, float TypeOfAnim)
{
    ...
    glPushMatrix();
        ...
        static float spriteXsize=320; //ïåðåìåííûå ñ ðàçìåðàìè òåêñòóðû è îòäåëüíîãî êàäðà
        static float spriteYsize=180;
        static float charsizey=60;
        static float charsizex=40;
        float left=(charsizex*NumberOfSprite)/spriteXsize; //âû÷èñëåíèå êîîðäèíàò êàäðà íà èçîáðàæåíèè îò
        float right=left+(charsizex/spriteXsize); //íîìåðà êàäðà
